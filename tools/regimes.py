...
# Флага «много родов» здесь больше НЕТ, и это результат замера, а не недосмотр.
# Полный граф скрещиваний на 88 подтверждающих прогонах: крупнейший род держит
# 77-89% всего населения в КАЖДОЙ точке, а «роды» сверх него — горстки по 5-20
# тел. Число компонент менялось (4-7), но смысла за этим нет: структура везде
# одна и та же — одно гигантское облако плюс свежие мутанты-спутники. Мерить
# режимы этим числом значит выдавать шум за явление.
