...
echo "label,seed,light,pdmg,dorm,extinct_h,org,photo,herb,pred,sapro,vir,virSd,inf,imm,keySd,dormAvg,myco,mycoShare,maxSize,dioecy,sexShare,seeds,spores,eggs,secs"
